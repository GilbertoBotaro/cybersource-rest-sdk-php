...
class ApiClient
{
    ...
    public function callApi($resourcePath, $method, $queryParams, $postData, $headerParams, $responseType=null)
    {
        ...
        $xPayToken = $this->generateXPayToken($resourcePath, $query, $postData);
        ...
        if ($response_info['http_code'] == 0) {
            ...
            $error = $this->serializer->deserialize(json_decode($http_body), '\CyberSource\Model\Error');
            $apiException = new ApiException(
                "[".$response_info['http_code']."] Error connecting to the API ($url)",
                $response_info['http_code'], $http_header, $http_body, $error
            );
            throw $apiException;
        }
     ...
     *
     * @param string $resourcePath The path to the resource without query parameters
     * @param string $query The full query string
     * @param string $postData The request body
     *
     * @return string The value for the x-pay-token header
     */
