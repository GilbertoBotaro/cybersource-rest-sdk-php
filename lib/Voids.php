...
class Voids
{
     ...
     * @throws \CyberSource\ApiException on non-2xx response
     */
    public function voidCredit($id, $request=null)
    {
     ...
     * @throws \CyberSource\ApiException on non-2xx response
     */
    public function voidRefund($id, $request=null)
    {
    ...
    public function voidSale($id, $request=null)
    {
        ...
        // verify the required parameter 'id' is set
        if ($id === null) {
            throw new \InvalidArgumentException('Missing the required parameter $id when calling voidSale');
        }
